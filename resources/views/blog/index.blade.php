...
<div class="container text-center">
    ...
    <a href="/blog/create" class="btn btn-info mb-4 center">Maak een nieuwe blog</a>
</div>
...
<div class="container d-flex flex-wrap">
    ...
    @foreach ($blogs as $blog)
            ...
            <div class="card mx-auto my-2" style="width:300px">
                <img  src="{{url('uploads/'.$blog->filename)}}" class="card-img-top img-thumbnail img-fluid" alt="{{$blog->filename}}" style="width: 300px; height: 200px;">
                    <div class="card-body">
                        ...
                        <a href="/blog/ {{ $blog->id }}" class="btn btn-info">Open Blog</a>
                    </div>
            </div>
